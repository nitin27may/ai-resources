...
echo -n "org-internal voice:               "; grep -rniE "our organization|the organization|our team|our stack|what we use|we invest|co-op|reach out to the team|our enterprise|our daily tools" docs | wc -l
